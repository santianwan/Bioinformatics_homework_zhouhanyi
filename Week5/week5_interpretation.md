...
This is the actual script that was run (also kept standalone at
[`code/week5_deseq2_analysis.R`](code/week5_deseq2_analysis.R) so it can be re-run without
copying it out of this document).
